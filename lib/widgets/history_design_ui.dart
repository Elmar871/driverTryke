            ...
            children: [
              Row(
                children: [
                  ...
                  SizedBox(width: 10),
                  Text(
                    "Passenger Name: ${widget.tripsHistoryModel!.userName!}",
              ...
              Row(
                children: [
                  ...
                  SizedBox(width: 10),
                  Text(
                    "Contact: ${widget.tripsHistoryModel!.userPhone!}",
                    style: TextStyle(fontWeight: FontWeight.bold),
                  ),
                ],
              ),
              ...
              Row(
                children: [
                  ...
                  SizedBox(width: 10),
                  Text(
                    "Ratings: ${widget.tripsHistoryModel!.ratingstoDriver!}",
                    style: TextStyle(fontWeight: FontWeight.bold),
                  ),
                ],
              ),
              SizedBox(height: 10),
              Text(
                "Comment: ${(widget.tripsHistoryModel!.comments!)}",
                style: TextStyle(fontWeight: FontWeight.bold),
              ),
            ],
          ),
