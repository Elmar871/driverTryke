...
class FareAmountCollectionDialogCancel extends StatefulWidget {
  double? totalFareAmount;
  TripsHistoryModel? trip;

  UserRideRequestInformation? userRideRequestInformation;

  FareAmountCollectionDialogCancel({this.totalFareAmount,this.trip,this.userRideRequestInformation});

  @override
  State<FareAmountCollectionDialogCancel> createState() => _FareAmountCollectionDialogCancelState();
}

class _FareAmountCollectionDialogCancelState extends State<FareAmountCollectionDialogCancel> {
  @override
