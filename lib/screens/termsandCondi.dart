...
class _TermsAndConditionsPageState extends State<TermsAndConditionsPage> {
  ...
  // block2ndViolation() async
  // {
  //   DatabaseReference secondsvio = FirebaseDatabase.instance.ref()
  //       .child("drivers")
  //       .child(FirebaseAuth.instance.currentUser!.uid);
  //
  //   await secondsvio.once().then((snap)
  //   {
  //     if(snap.snapshot.value != null)
  //     {
  //       if((snap.snapshot.value as Map)["blockStatus"] == "yes" && ["counter"] == 1 )
  //       {
  //           firebaseAuth.signOut();
  //           Navigator.push(context, MaterialPageRoute(builder: (c)=> ViolationDialog()));
  //           // Update blockStatus to 'yes' if ratingsToUser is below 1
  //           secondsvio.update({"blockStatus": "yes"}).then((_) {
  //             setState(() {
...
//                   '1.1 The App is designed to facilitate booking rides with tricycle drivers in Sta. Cruz, Laguna.\n\n'
//                   '1.2 You must be at least 18 years old to use the App.\n\n'
//                   '1.3 You agree to provide accurate and complete information when using the App, including your name, address, contact number, email, and location.\n\n'
//                   '2. Privacy Policy\n\n'
//                   '2.1 By using the App, you agree to the collection and use of your personal information in accordance with our Privacy Policy.\n\n'
//                   '2.2 We may collect and store your personal information for the purpose of providing the services offered by the App.\n\n'
//                   '3. Payment\n\n'
