...
import '../widgets/blockpermanent.dart';
    ...
    if(_formKey.currentState!.validate()) {
      await firebaseAuth.signInWithEmailAndPassword(
        ...
        userRef.child(firebaseAuth.currentUser!.uid).once().then((value) async {
          ...
          if(snap.value != null){
            if ((snap.value as Map)["counterLogin"] == "1" && (snap.value as Map)["blockStatus"] == "yes") {
          ...
          if(snap.value != null){
            if ((snap.value as Map)["blockStatus"]=="no"){
              ...
              if ((snap.value as Map)["counterLogin"] == "1" && (snap.value as Map)["blockStatus"] == "yes") {
                ...
                showDialog(context: context, builder: (context) => BlockPermanent());
              }else {
        ...
        userRef.child(firebaseAuth.currentUser!.uid).once().then((value) async {
          ...
          switch (snap.value != null) {
            case true:
              ...
              else if ((snap.value as Map)["blockStatus"] == "yes" || (snap.value as Map)["ratings"] >=3  ) {
                Navigator.push(context, MaterialPageRoute(builder: (c) => FirstOffense()));
              }
              else {
                Navigator.push(context, MaterialPageRoute(builder: (c) => FirstOffense()));
